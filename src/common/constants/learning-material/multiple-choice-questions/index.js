...
export default [
  <MultipleChoiceQuestion titleText="Mark the correct meaning" questionText="One, Two, Three!" possibleAnswers={['¡Uno, dos, tres!', '¡Un, queso, 3', '¡1, sal y 3!']} correctAnswer="¡Uno, dos, tres!" buttonText="Check Result" correctResultTitle="Correct Result!" correctResultText="Well Done." incorrectResultTitle="Correct Result:" incorrectResultText="" />,
];
